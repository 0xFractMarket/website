                    ...
                    <div className="xl:col-span-9 lg:col-span-8 md:col-span-8">
                        <div className="grid grid-cols-1 gap-6">
                                ...
                                <form>
                                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                        ...
                                        <div>
                                            ...
                                            <div className="form-icon relative mt-2">
                                                <FiUserCheck className="size-4 absolute top-3 start-4"/>
                                        ...
                                        <div>
                                            ...
                                            <div className="form-icon relative mt-2">
                                                <FiBookmark className="size-4 absolute top-3 start-4"/>
                                        ...
                                        <form>
                                            <div className="grid grid-cols-1 gap-5">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="form-icon relative mt-2">
                                                        <FiGlobe className="size-4 absolute top-3 start-4"></FiGlobe>
                                        ...
                                        <form>
                                            <div className="grid grid-cols-1 gap-5">
                                                <div>
                                                    ...
                                                    <div className="form-icon relative mt-2">
                                                        <FiKey className="size-4 absolute top-3 start-4"/>
                            ...
                            <div className="p-6 relative rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                                ...
                                <Link to="" className="btn bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">Delete</Link>
                            </div>
                        </div>
                    </div>
                </div>
