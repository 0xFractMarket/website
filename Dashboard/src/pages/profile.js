...
export default function Profile(){
    let [file, setFile] = useState(client7);
                ...
                <div className="grid grid-cols-1">
                    <div className="profile-banner relative text-transparent rounded-md shadow dark:shadow-gray-700 overflow-hidden">
                        ...
                        <div className="relative shrink-0">
                            <img src={bg1} className="h-80 w-full object-cover" id="profile-banner" alt=""/>
                            ...
                            <div className="profile-pic text-center mb-5">
                                ...
                                <div>
                                    <div className="relative size-24 mx-auto">
                                        <img src={file} className="rounded-full shadow dark:shadow-gray-700 ring-4 ring-slate-50 dark:ring-slate-800" id="profile-image" alt=""/>
                                ...
                                <div className="mt-4">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <Link to="" className="text-slate-400">calvin@hotmail.com</Link>
                                        </div>
                                    </div>
                                    <div className="flex items-center mt-3">
                                        <FiBookmark className="fea icon-ex-md text-slate-400 me-3 size-6"/>
                                        <div className="flex-1">
                                    ...
                                    <div className="flex items-center mt-3">
                                        <FiItalic className="fea icon-ex-md text-slate-400 me-3 size-6"/>
                                        <div className="flex-1">
                                    ...
                                    <div className="flex items-center mt-3">
                                        <FiGift className="fea icon-ex-md text-slate-400 me-3 size-6"/>
                                        <div className="flex-1">
                                    ...
                                    <div className="flex items-center mt-3">
                                        <FiMapPin className="fea icon-ex-md text-slate-400 me-3 size-6"/>
                                        <div className="flex-1">
                                    ...
                                    <div className="flex items-center mt-3">
                                        <FiPhone className="fea icon-ex-md text-slate-400 me-3 size-6"/>
                                        <div className="flex-1">
                                ...
                                <div className="grid lg:grid-cols-3 md:grid-cols-2 mt-6 gap-6">
                                    {propertiesData.slice(0,6).map((item, index) =>{
                                        ...
                                        <div className="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500" key={index}>
                                            ...
                                            <div className="p-6">
                                                <div className="pb-6">
                                                    <Link to="property-detail.html" className="text-lg hover:text-green-600 font-medium ease-in-out duration-500">{item.name}</Link>
                                                </div>
